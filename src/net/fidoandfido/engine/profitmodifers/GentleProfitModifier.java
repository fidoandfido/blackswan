 ...
 * 
 */
public class GentleProfitModifier implements EventProfitModifier {
	...
	public QuarterData adjustProfit(QuarterPerformanceType eventType, QuarterData eventData, Company company, CompanyPeriodReport companyPeriodReport,
		...
		case CATASTROPHIC:
			...
			revenue = revenue * getPercentageInRange(60, 80) / 100;
			expenses = expenses * getPercentageInRange(120, 140) / 100;
			break;
		case TERRIBLE:
			// Revenues down, expenses up - variance 25%
			revenue = revenue * getPercentageInRange(70, 90) / 100;
		...
		case GOOD:
			...
			revenue = revenue * getPercentageInRange(85, 105) / 100;
			expenses = expenses * getPercentageInRange(100, 120) / 100;
			break;
		case GREAT:
			// Revenues up, expenses down - variance 25%
			revenue = revenue * getPercentageInRange(105, 125) / 100;
			expenses = expenses * getPercentageInRange(70, 90) / 100;
			break;
		case EXTRAORDINARY:
			// Revenues WAY UP, Expenses SLASHED - variance LARGE
			revenue = revenue * getPercentageInRange(120, 140) / 100;
			expenses = expenses * getPercentageInRange(60, 80) / 100;
			break;
		}
	...
	public static void main(String argv[]) {
		...
		GentleProfitModifier modifier = new GentleProfitModifier();
