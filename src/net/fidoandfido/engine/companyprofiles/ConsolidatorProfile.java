...
public class ConsolidatorProfile extends CompanyProfile {

	public static final String NAME = "Consolidator";
	...
	public CompanyModifier getCompanyModifier(Company company) {
		...
		// -- minimum operating profit is interest rate + 3
		// -- maximum operating profit is interest rate + 8
		return new GentleCompanyModifier(20, 10, 30, 10, 30, interestRate + 3, interestRate + 8);
	}
