...
public class TraderEvent {
	...
	public TraderEvent(Trader trader, String eventType, Date date, Company company, long shareCount, long amountTransferred, long startingCash, long endingCash) {
		super();
		this.trader = trader;
	...
	public TraderEvent(Trader trader, String eventType, Date date, ReputationItem item, long amountTransferred, long startingCash, long endingCash) {
		super();
		this.trader = trader;
		this.eventType = eventType;
		this.date = date;
	 ...
	 *            the item to set
	 */
	public void setItem(ReputationItem item) {
		this.item = item;
	}
