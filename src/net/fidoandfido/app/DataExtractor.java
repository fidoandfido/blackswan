...
public class DataExtractor {
	...
	private void getExchangeList() {
		...
		for (StockExchange stockExchange : stockExchangeList) {
			...
			System.out.println("Total company count: " + stockExchangeDAO.getCompaniesCountForExchange(stockExchange));
			System.out.println("Still trading company count: " + stockExchangeDAO.getTradingCompaniesCountForExchange(stockExchange));
			System.out.println("Stock exchange company count: " + stockExchange.getCompanyCount());
